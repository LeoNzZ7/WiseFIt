...
export const FeedbackSuccessStep = ({ onFeedbackRestart }: Props) => {
    return (
        <>
            ...
            <button onClick={onFeedbackRestart} type="button" className="py-2 px-6 mb-6 mt-6 bg-neutral-800 rounded-md border-transparent text-sm leading-6 hover:bg-neutral-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-neutral-900 focus:ring-brand-100" >Quer enviar outro?</button>
        </>
    );
}